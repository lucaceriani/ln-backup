...
var grammar = {
    ...
    {"name": "comando$ebnf$2", "symbols": ["Src"]},
    {"name": "comando$ebnf$2", "symbols": ["comando$ebnf$2", "Src"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "comando$ebnf$3", "symbols": ["Escl"]},
    {"name": "comando$ebnf$3", "symbols": ["comando$ebnf$3", "Escl"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "comando", "symbols": ["Name", "comando$ebnf$2", "comando$ebnf$3", "Dst"], "postprocess": ([name, src, excl, dst]) => ({name, src, excl, dst})},
    ...
    {"name": "Escl$ebnf$1", "symbols": ["newline"]},
    {"name": "Escl$ebnf$1", "symbols": ["Escl$ebnf$1", "newline"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "Escl", "symbols": [{"literal":"E"}, "_", "param", "Escl$ebnf$1"], "postprocess": d => d[2]},
